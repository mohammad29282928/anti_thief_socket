...
class LoadImages:
    ...
    def __init__(self, path, img_size=640, stride=32, auto=True, transforms=None, vid_stride=7):
        files = []
    ...
    def __next__(self):
        ...
        return path, im, im0, self.cap, s, True
...
class LoadStreams:
    ...
    def __init__(self, sources='streams.txt', img_size=640, stride=32, auto=True, transforms=None, vid_stride=1):
        ...
        for i, s in enumerate(sources):  # index, source
            ...
            # print(self.img_size)
            self.imgs[i] = cv2.resize(self.imgs[i], self.img_size) 
    ...
    def __next__(self):
        ...
        return self.sources, im, im0, None, '', self.success
